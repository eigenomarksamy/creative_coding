...
for i in range(200):
    draw_recursive_glitch(ctx, random.uniform(0, WIDTH), random.uniform(0, HEIGHT), random.randint(1, 1000), 0, random.randint(1, 6), symmetry=8)

# Save result
surface.write_to_png("cc_pycairo/gen/textures_but_randomized.png")
print("Saved textures_but_randomized.png")
