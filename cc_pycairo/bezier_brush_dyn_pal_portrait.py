...
# Save image
# --------------------------
surface.write_to_png("cc_pycairo/gen/bezier_brush_dynamic_palette_portrait.png")
print("Saved bezier_brush_dynamic_palette_portrait.png")
